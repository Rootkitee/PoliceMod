...
//Mod
//Server Num (nombre du serveur) : si jamais tu vois 0 quelque part, c'est que tu n'as pas réglé ton cfg
MACRO_CONFIG_INT(SvServerNum, server_num, 0, 0, 20, CFGFLAG_SERVER, "Server number")
