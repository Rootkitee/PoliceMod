...
class CGameContext : public IGameServer
{
	...
	static void ConSetHammerPower(IConsole::IResult *pResult, void *pUserData);
...
public:
	...
	void RegisterExtraCmds();

	bool CheckLoggedAccount(const char* AccountName = 0);
    int CharToInt(const char *pNum);

	char m_ConnectedAccounts[MAX_CLIENTS][32];
private:
    int m_SendMsgTick;
    int m_SendMsgID;
};
